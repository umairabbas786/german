...
const LLM_BOX_FIXED =
  'max-lg:fixed max-lg:inset-x-0 max-lg:bottom-0 max-lg:z-[420] max-lg:m-0 max-lg:max-w-none max-lg:min-h-[calc(100px+env(safe-area-inset-bottom,0px))] max-lg:w-full max-lg:overflow-hidden max-lg:rounded-none max-lg:border-0 max-lg:bg-[linear-gradient(90deg,#e2bea9,#b8b0d3)] max-lg:px-8 max-lg:py-6 max-lg:pb-[calc(24px+env(safe-area-inset-bottom,0px))] max-lg:shadow-none max-lg:backdrop-blur-none lg:max-[1366px]:fixed lg:max-[1366px]:inset-x-0 lg:max-[1366px]:bottom-0 lg:max-[1366px]:z-[420] lg:max-[1366px]:m-0 lg:max-[1366px]:max-w-none lg:max-[1366px]:min-h-[calc(100px+env(safe-area-inset-bottom,0px))] lg:max-[1366px]:w-full lg:max-[1366px]:overflow-hidden lg:max-[1366px]:rounded-none lg:max-[1366px]:border-0 lg:max-[1366px]:bg-[linear-gradient(90deg,#e2bea9,#b8b0d3)] lg:max-[1366px]:px-8 lg:max-[1366px]:py-6 lg:max-[1366px]:pb-[calc(24px+env(safe-area-inset-bottom,0px))] lg:max-[1366px]:shadow-none lg:max-[1366px]:backdrop-blur-none';

const LLM_GLOW =
  'pointer-events-none absolute inset-[-1px] -z-10 animate-settings-glow rounded-2xl bg-[linear-gradient(45deg,rgba(120,119,198,0.5),rgba(255,206,84,0.5),rgba(120,119,198,0.5),rgba(255,206,84,0.5))] bg-size-[400%_400%] opacity-80 max-lg:hidden lg:max-[1366px]:hidden';
